                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="receivedSmsEmailInput">
                                            <input <?php if(isDemo()) echo "disabled"; ?> type="checkbox" name="smsToEmail" value="1" id="toggleReceivedSmsEmailInput"
                                            ...
                                            <?= __("send_received_messages_to_email"); ?> <?php if(isDemo()) echo "(" . __('disabled_by_admin') . ")" ?>
                                        </label>
